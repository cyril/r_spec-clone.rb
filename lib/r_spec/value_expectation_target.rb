...
module RSpec
  ...
  #
  # @example
  #   expect(something) # => ValueExpectationTarget wrapping something
  #
  #   # used with `to`
  ...
  #
  # @note `ValueExpectationTarget` is not intended to be instantiated directly
  ...
  class ValueExpectationTarget
    ...
    def result(matcher:, negate:, valid:)
